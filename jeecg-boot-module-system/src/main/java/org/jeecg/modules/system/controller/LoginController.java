...
public class LoginController {
    ...
    @PostMapping(value = "/loginForJsonStr")
	public Result<JSONObject> loginForJsonStr(String userStr) throws Exception {
		Result<JSONObject> result = new Result<JSONObject>();
		if (null==userStr) {
			result.error500("账号密码不能为空");
			return result;
		}
		SysLoginModel sysLoginModel = JSON.parseObject(userStr, SysLoginModel.class);
